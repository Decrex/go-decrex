...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/decrx.ipc",
			endpoint:    "/data/testnet/decrx.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/decrx.ipc",
			endpoint:    "/data/testnet/decrx.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/decrx.ipc",
			endpoint:    "/data/testnet/decrx.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/decrx.ipc",
			endpoint:    "/data/testnet/decrx.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
