...
The dashboard is a data visualizer integrated into decrx, intended to collect and visualize useful information of an Ethereum node. It consists of two parts:
...
```
$ decrx --dashboard --vmodule=dashboard=5
