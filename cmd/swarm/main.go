...
import (
	...
	"github.com/decrx/go-decrx/ethclient"
	"github.com/decrx/go-decrx/internal/debug"
	...
	"github.com/decrx/go-decrx/swarm"
	bzzapi "github.com/decrx/go-decrx/swarm/api"
	swarmmetrics "github.com/decrx/go-decrx/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside decrx.
func init() {
...
func bzzd(ctx *cli.Context) error {
	...
	//decrx only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for decrx and swarm
