...
import (
	...
	whisper "github.com/decrx/go-decrx/whisper/whisperv6"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `decrx account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. decrx account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// decrx --keystore /tmp/mykeystore --lightkdf account new
//
