...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "decrx.ipc", false, filepath.Join(os.TempDir(), "decrx.ipc")},
		{"data", "decrx.ipc", false, "data/decrx.ipc"},
		{"data", "./decrx.ipc", false, "./decrx.ipc"},
		{"data", "/decrx.ipc", false, "/decrx.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "decrx.ipc", true, `\\.\pipe\decrx.ipc`},
		{"data", "decrx.ipc", true, `\\.\pipe\decrx.ipc`},
		{"data", `\\.\pipe\decrx.ipc`, true, `\\.\pipe\decrx.ipc`},
	}
